...
function SettingsPage() {
  ...
  const handleChange = (e) => {
    ...
    if (passwordSuccess && (name === 'currentPassword' || name === 'newPassword' || name === 'confirmPassword')) {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Appearance Settings */}
      <div className="card">
        <h2 className="text-xl font-medium mb-6">Préférences d'affichage</h2>
        
        <div className="form-group">
          <label className="form-label">Thème</label>
          <div className="mt-2 space-x-2">
            <button className="btn-secondary py-1 px-3">Clair</button>
            <button className="btn-secondary py-1 px-3 opacity-50">Sombre (Bientôt disponible)</button>
          </div>
        </div>
        ...
        <div className="form-group mt-4">
          ...
          <div className="mt-2 space-x-2">
            <button className="btn-secondary py-1 px-3">Français</button>
            <button className="btn-secondary py-1 px-3 opacity-50">English (Coming soon)</button>
          </div>
        </div>
      </div>
    </div>
